 ...
 */
import { TableOptionRadioControl, TableOptionSelectControl, TableOptionTextControl } from './_common-components';
						...
						{ ( 'sort' === shortcodeAttrs.named.row_order ) &&
							<>
								<TableOptionTextControl
									label={ __( 'Sort column:', 'tablepress' ) }
									help={ __( 'Enter the column which shall be sorted on, e.g. “2”.', 'tablepress' ) }
