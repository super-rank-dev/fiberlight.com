...
trait TablePress_Module {
	 ...
	 */
	public static function print_help_box_markup( $help_box_content = '', $height = '', $width = '' ) {
		...
		<div id="help-box-<?php echo esc_attr( self::$module['slug'] ); ?>" class="help-box hidden-container" title="<?php echo esc_attr( self::$module['name'] ); ?>" data-height="<?php echo esc_attr( $height ); ?>" data-width="<?php echo esc_attr( $width ); ?>">
			...
			<p><a href="<?php echo esc_url( 'https://tablepress.org/modules/' . self::$module['slug'] . '/' ); ?>" class="module-link" target="_blank" rel="noopener"><?php _e( 'More Details, Examples, and Documentation', 'tablepress' ); ?></a></p>
		</div>
		<?php
	}
