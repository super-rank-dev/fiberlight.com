...
class TablePress_Modules_Helper {
	 ...
	 */
	public static function enqueue_style( $name, array $dependencies = array() ) {
	 ...
	 */
	public static function enqueue_script( $name, array $dependencies = array(), array $script_data = array() ) {
