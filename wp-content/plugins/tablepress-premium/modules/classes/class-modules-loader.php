...
class TablePress_Modules_Loader {
	 ...
	 * @const string
	 */
	const MINIMUM_MODULES_PLAN = 'pro';
	 ...
	 */
	public static function load_early_modules( $exit_early ) {
	 ...
	 */
	public static function init_active_modules_plugin_option() {
	 ...
	 * @since 2.0.0
	 */
	public static function show_failed_modules_error_notice() {
	 ...
	 */
	public static function change_modules_view_full_path( $full_path, $file, $folder ) {
	 ...
	 */
	public static function add_view_action_modules( array $view_actions ) {
		$view_modules = array(
			'modules' => array(
				'show_entry'       => true,
				...
				'required_cap'     => 'manage_options', // Only grant access to the Debug area for admins.
			),
		);
	 ...
	 * @return array The extended view data.
	 */
	public static function add_modules_view_data( array $data, $action ) {
		if ( 'modules' !== $action ) {
			return $data;
		}
	 ...
	 * @since 2.0.0
	 */
	public static function handle_post_action_modules() {
