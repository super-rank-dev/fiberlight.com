...
abstract class TablePress_View {
	...
	public function __construct() {
		...
		if ( tb_tp_fs()->is_plan_or_trial__premium_only( 'pro' ) ) {
			$common_content .= '<p>' . __( 'Your site has a valid Premium license plan for TablePress, which makes you eligible for Priority Email Support.', 'tablepress' ) . ' ' . sprintf( __( 'If you need assistance, <a href="%s">please get in touch!</a>', 'tablepress' ), 'mailto:premium-support@tablepress.org' );
		}
