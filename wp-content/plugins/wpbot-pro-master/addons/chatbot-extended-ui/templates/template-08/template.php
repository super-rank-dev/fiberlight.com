...
.wp-bot-header path {
    fill: <?php echo get_option('wp_chatbot_theme_primary_color') ?> !important;
}
</style>
<?php endif; ?>
  ...
  <div class="wp-chatbot-container">
    ...
    <div id="wp-chatbot-board-container" class="wp-chatbot-board-container">
      <div class="wp-bot-header">
        ...
        <?php if( (get_option('enable_wp_chatbot_skype_floating_icon') == 1) || (get_option('enable_wp_chatbot_floating_whats') == 1) || (get_option('enable_wp_chatbot_floating_viber') == 1) || (get_option('enable_wp_chatbot_floating_phone') == 1 && get_option('qlcd_wp_chatbot_phone') != "") || (get_option('enable_wp_chatbot_floating_livechat') == 1 && get_option('enable_wp_chatbot_floating_livechat') != "") || (get_option('enable_wp_chatbot_floating_link') == 1 && get_option('qlcd_wp_chatbot_weblink') != "")) :?>
        <div class="wp-bot-burger-menu-icon">
          <div class="menu__container">
            ...
            <div id="menuItems" class="menu__items">
                <div class="wp-chatbot-template-06-integration-buttons">
        ...
        <div class="SVGBg" style="height: 55px;overflow: hidden;background: #fff;" ><svg viewBox="0 0 500 150" preserveAspectRatio="none" style="height: 100%; width: 100%;">
