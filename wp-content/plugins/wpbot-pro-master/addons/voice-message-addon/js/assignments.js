...
(function(core) {
    ...
    UI.Utils.checkDisplay = function(context, initanimation) {
        ...
        var elements = UI.$('[data-vmwbmdp-margin], [data-vmwbmdp-grid-match], [data-vmwbmdp-grid-margin], [data-vmwbmdp-check-display]', context || document), animated;
        ...
        if (initanimation) {
            ...
            if (typeof(initanimation)!='string') {
                initanimation = '[class*="vmwbmdp-animation-"]';
            }
            ...
            elements.find(initanimation).each(function(){
                ...
                var ele  = UI.$(this),
                    cls  = ele.attr('class'),
                    anim = cls.match(/vmwbmdp-animation-(.+)/);
    ...
    document.addEventListener('DOMContentLoaded', function(){
        ...
        var domReady = function() {
            ...
            if (UI.support.touch) {
                ...
                // viewport unit fix for vmwbmdp-height-viewport - should be fixed in iOS 8
                if (navigator.userAgent.match(/(iPad|iPhone|iPod)/g)) {

                    UI.$win.on('load orientationchange resize', UI.Utils.debounce((function(){

                        var fn = function() {
                            $('.vmwbmdp-height-viewport').css('height', window.innerHeight);
                            return fn;
                        };
                ...
                (new UI.support.mutationobserver(function(mutations) {
                    ...
                    mutations.every(function(mutation){
                        ...
                        for (var i = 0, node; i < mutation.addedNodes.length; ++i) {
                            ...
                            if (node.outerHTML && node.outerHTML.indexOf('data-vmwbmdp-') !== -1) {
    ...
    UI.$html.addClass(UI.support.touch ? 'vmwbmdp-touch' : 'vmwbmdp-notouch');

    // add vmwbmdp-hover class on tap to support overlays on touch devices
    if (UI.support.touch) {

        var hoverset = false,
            exclude,
            hovercls = 'vmwbmdp-hover',
            selector = '.vmwbmdp-overlay, .vmwbmdp-overlay-hover, .vmwbmdp-overlay-toggle, .vmwbmdp-animation-hover, .vmwbmdp-has-hover';
...
(function(UI) {
    ...
    UI.component('stackMargin', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-margin]', context).each(function() {

                    var ele = UI.$(this);

                    if (!ele.data('stackMargin')) {
                        UI.stackMargin(ele, UI.Utils.options(ele.attr('data-vmwbmdp-margin')));
                    }
                });
            });
        },
        ...
        UI.component('responsiveElement', {
            ...
            boot: function() {
                ...
                UI.ready(function(context) {
                    ...
                    UI.$('iframe.vmwbmdp-responsive-width, [data-vmwbmdp-responsive]', context).each(function() {
    ...
    (function(cacheSvgs){
        ...
        // init code
        UI.ready(function(context) {
            UI.Utils.inlineSvg('[data-vmwbmdp-svg]', context);
        });
...
(function(UI) {
    ...
    UI.component('smoothScroll', {
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on('click.smooth-scroll.uikit', '[data-vmwbmdp-smooth-scroll]', function(e) {
                var ele = UI.$(this);

                if (!ele.data('smoothScroll')) {
                    var obj = UI.smoothScroll(ele, UI.Utils.options(ele.attr('data-vmwbmdp-smooth-scroll')));
                    ele.trigger('click');
                }
...
(function(UI) {
    ...
    UI.component('scrollspy', {
        ...
        defaults: {
            target     : false,
            cls        : 'vmwbmdp-scrollspy-inview',
            initcls    : 'vmwbmdp-scrollspy-init-inview',
            topoffset  : 0,
            leftoffset : 0,
            repeat     : false,
            delay      : 0
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-scrollspy]', context).each(function() {

                    var element = UI.$(this);

                    if (!element.data('scrollspy')) {
                        var obj = UI.scrollspy(element, UI.Utils.options(element.attr('data-vmwbmdp-scrollspy')));
                    }
                });
            });
        },
            ...
            var $this = this, inviewstate, initinview, togglecls = this.options.cls.split(/,/), fn = function(){
                ...
                elements.each(function(idx){
                    ...
                    var element     = UI.$(this),
                        ...
                        toggle      = element.attr('data-vmwbmdp-scrollspy-cls') || togglecls[toggleclsIdx].trim();
                    ...
                    if (inview && !inviewstate && !element.data('scrollspy-idle')) {
                        ...
                        element.data('scrollspy-idle', setTimeout(function(){
                            ...
                            element.addClass('vmwbmdp-scrollspy-inview').toggleClass(toggle).width();
                    ...
                    if (!inview && inviewstate && $this.options.repeat) {
                        ...
                        element.removeClass('vmwbmdp-scrollspy-inview').toggleClass(toggle);
    ...
    UI.component('scrollspynav', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-scrollspy-nav]', context).each(function() {

                    var element = UI.$(this);

                    if (!element.data('scrollspynav')) {
                        var obj = UI.scrollspynav(element, UI.Utils.options(element.attr('data-vmwbmdp-scrollspy-nav')));
                    }
                });
            });
        },
    ...
    UI.component('toggle', {
        ...
        boot: function(){
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-toggle]', context).each(function() {
                    var ele = UI.$(this);

                    if (!ele.data('toggle')) {
                        var obj = UI.toggle(ele, UI.Utils.options(ele.attr('data-vmwbmdp-toggle')));
                    }
                });
        ...
        init: function() {
            ...
            this.aria = (this.options.cls.indexOf('vmwbmdp-hidden') !== -1);
            ...
            if (this.options.animation && UI.support.animation) {
                ...
                this.totoggle.each(function(){
                    ...
                    if (ele.hasClass($this.options.cls)) {
                        ...
                        UI.Utils.animate(this, animations[1]+' vmwbmdp-animation-reverse').then(function(){
        ...
        updateAria: function() {
            if (this.aria && this.totoggle.length) {
                this.totoggle.not('[aria-hidden]').each(function(){
                    UI.$(this).attr('aria-hidden', UI.$(this).hasClass('vmwbmdp-hidden'));
                });
            }
        }
    });
...
(function(UI) {
    ...
    UI.component('alert', {
        ...
        defaults: {
            fade: true,
            duration: 200,
            trigger: '.vmwbmdp-alert-close'
        },

        boot: function() {

            // init code
            UI.$html.on('click.alert.uikit', '[data-vmwbmdp-alert]', function(e) {

                var ele = UI.$(this);

                if (!ele.data('alert')) {

                    var alert = UI.alert(ele, UI.Utils.options(ele.attr('data-vmwbmdp-alert')));
...
(function(UI) {
    ...
    UI.component('buttonRadio', {
        ...
        defaults: {
            activeClass: 'vmwbmdp-active',
            target: '.vmwbmdp-button'
        },

        boot: function() {

            // init code
            UI.$html.on('click.buttonradio.uikit', '[data-vmwbmdp-button-radio]', function(e) {

                var ele = UI.$(this);

                if (!ele.data('buttonRadio')) {

                    var obj    = UI.buttonRadio(ele, UI.Utils.options(ele.attr('data-vmwbmdp-button-radio'))),
                        target = UI.$(e.target);
    ...
    UI.component('buttonCheckbox', {
        ...
        boot: function() {
            ...
            UI.$html.on('click.buttoncheckbox.uikit', '[data-vmwbmdp-button-checkbox]', function(e) {
                var ele = UI.$(this);

                if (!ele.data('buttonCheckbox')) {

                    var obj    = UI.buttonCheckbox(ele, UI.Utils.options(ele.attr('data-vmwbmdp-button-checkbox'))),
                        target = UI.$(e.target);
    ...
    UI.component('button', {
        ...
        boot: function() {
            ...
            UI.$html.on('click.button.uikit', '[data-vmwbmdp-button]', function(e) {
                var ele = UI.$(this);

                if (!ele.data('button')) {

                    var obj = UI.button(ele, UI.Utils.options(ele.attr('data-vmwbmdp-button')));
                    ele.trigger('click');
                }
            });
        },
        ...
        init: function() {
            ...
            // Init ARIA
            this.element.attr('aria-pressed', this.element.hasClass("vmwbmdp-active"));
            ...
            this.on('click', function(e) {
                ...
                $this.toggle();
                $this.trigger('change.uk.button', [$this.element.blur().hasClass('vmwbmdp-active')]);
            });

        },

        toggle: function() {
            this.element.toggleClass('vmwbmdp-active');
...
(function(UI) {
    ...
    UI.component('dropdown', {
        ...
        defaults: {
           ...
           boundary        : UI.$win,
           delay           : 0,
           dropdownSelector: '.vmwbmdp-dropdown,.vmwbmdp-dropdown-blank',
           hoverDelayIdle  : 250,
           preventflip     : false
        },
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on(triggerevent+'.dropdown.uikit focus pointerdown', '[data-vmwbmdp-dropdown]', function(e) {

                var ele = UI.$(this);

                if (!ele.data('dropdown')) {

                    var dropdown = UI.dropdown(ele, UI.Utils.options(ele.attr('data-vmwbmdp-dropdown')));
        ...
        init: function() {
            ...
            this.centered  = this.dropdown.hasClass('vmwbmdp-dropdown-center');
            ...
            // legacy DEPRECATED!
            if (this.dropdown.hasClass('vmwbmdp-dropdown-up')) {
                this.options.pos = 'top-left';
            }
            if (this.dropdown.hasClass('vmwbmdp-dropdown-flip')) {
                this.options.pos = this.options.pos.replace('left','right');
            }
            if (this.dropdown.hasClass('vmwbmdp-dropdown-center')) {
            ...
            this.element.attr('aria-expanded', this.element.hasClass('vmwbmdp-open'));
            ...
            if (this.options.mode == 'click' || UI.support.touch) {
                ...
                this.on('click.uk.dropdown', function(e) {
                    ...
                    if (!$this.element.hasClass('vmwbmdp-open')) {

                        $this.show();

                    } else {

                        if (!$this.dropdown.find(e.target).length || $target.is('.vmwbmdp-dropdown-close') || $target.parents('.vmwbmdp-dropdown-close').length) {
                            $this.hide();
                        }
                    }
                });
        ...
        show: function(){
            ...
            this.element.addClass('vmwbmdp-open');
        ...
        hide: function(force) {
            ...
            this.element.removeClass('vmwbmdp-open');
        ...
        checkDimensions: function() {
            ...
            // reset
            this.dropdown.removeClass('vmwbmdp-dropdown-top vmwbmdp-dropdown-bottom vmwbmdp-dropdown-left vmwbmdp-dropdown-right vmwbmdp-dropdown-stack vmwbmdp-dropdown-autoflip').css({
                topLeft :'',
                left :'',
                marginLeft :'',
                marginRight :''
            ...
            if (this.justified && this.justified.length) {
                ...
                if (this.options.preventflip !== true) {
                    ...
                    if (fdpos) {
                        ...
                        dropdown.addClass('vmwbmdp-dropdown-autoflip');
            ...
            if (width > boundarywidth) {
                dropdown.addClass('vmwbmdp-dropdown-stack');
                this.trigger('stack.uk.dropdown', [this]);
            }

            dropdown.css(css).css('display', '').addClass('vmwbmdp-dropdown-'+pp[0]);
        },
    ...
    UI.component('dropdownOverlay', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-dropdown-overlay]', context).each(function() {
                    var ele = UI.$(this);

                    if (!ele.data('dropdownOverlay')) {
                        UI.dropdownOverlay(ele, UI.Utils.options(ele.attr('data-vmwbmdp-dropdown-overlay')));
                    }
                });
            });
        },
        ...
        init: function() {
            ...
            this.justified = this.options.justify ? UI.$(this.options.justify) : false;
            this.overlay   = this.element.find('vmwbmdp-dropdown-overlay');

            if (!this.overlay.length) {
                this.overlay = UI.$('<div class="vmwbmdp-dropdown-overlay"></div>').appendTo(this.element);
            }
            ...
            this.on({
                ...
                'show.uk.dropdown': function(e, dropdown) {
                    ...
                    $this.dropdown.element.removeClass('vmwbmdp-open');

                    $this.overlay.stop().css('display', 'block').animate({height: h}, $this.options.duration, function() {

                       $this.dropdown.dropdown.css('visibility', '');
                       $this.dropdown.element.addClass('vmwbmdp-open');
...
(function(UI) {
    ...
    UI.component('gridMatchHeight', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-grid-match]', context).each(function() {
                    var grid = UI.$(this), obj;

                    if (!grid.data('gridMatchHeight')) {
                        obj = UI.gridMatchHeight(grid, UI.Utils.options(grid.attr('data-vmwbmdp-grid-match')));
                    }
                });
            });
        },
    ...
    UI.component('gridMargin', {
        ...
        defaults: {
            cls      : 'vmwbmdp-grid-margin',
            rowfirst : 'vmwbmdp-row-first'
        },
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-grid-margin]', context).each(function() {
                    var grid = UI.$(this), obj;

                    if (!grid.data('gridMargin')) {
                        obj = UI.gridMargin(grid, UI.Utils.options(grid.attr('data-vmwbmdp-grid-margin')));
                    }
                });
            });
        },
...
(function(UI) {
    ...
    UI.$win.on('resize orientationchange', UI.Utils.debounce(function(){
        UI.$('.vmwbmdp-modal.vmwbmdp-open').each(function(){
    ...
    UI.component('modal', {
        ...
        init: function() {
            ...
            this.dialog     = this.find('.vmwbmdp-modal-dialog');

            this.active     = false;

            // Update ARIA
            this.element.attr('aria-hidden', this.element.hasClass('vmwbmdp-open'));

            this.on('click', '.vmwbmdp-modal-close', function(e) {
                e.preventDefault();
                $this.hide();
            }).on('click', function(e) {
        ...
        show: function() {
            ...
            this.element.removeClass('vmwbmdp-open').show();
            this.resize(true);
            ...
            if (UI.support.transition) {
                ...
                }).addClass('vmwbmdp-open');
            } else {
                this.element.addClass('vmwbmdp-open');
                UI.Utils.focus(this.dialog, 'a[href]');
            }

            $html.addClass('vmwbmdp-modal-page').height(); // force browser engine redraw
        ...
        updateScrollable: function() {
            ...
            // has scrollable?
            var scrollable = this.dialog.find('.vmwbmdp-overflow-container:visible:first');
        ...
        _hide: function() {
            ...
            this.element.hide().removeClass('vmwbmdp-open');

            // Update ARIA
            this.element.attr('aria-hidden', 'true');

            if (!activeCount) {
                $html.removeClass('vmwbmdp-modal-page');
        ...
        isActive: function() {
            return this.element.hasClass('vmwbmdp-open');
        }
    ...
    UI.component('modalTrigger', {
        ...
        boot: function() {
            ...
            // init code
            UI.$html.on('click.modal.uikit', '[data-vmwbmdp-modal]', function(e) {
                ...
                if (!ele.data('modalTrigger')) {
                    var modal = UI.modalTrigger(ele, UI.Utils.options(ele.attr('data-vmwbmdp-modal')));
                    modal.show();
                }
    ...
    UI.modal.dialog.template = '<div class="vmwbmdp-modal"><div class="vmwbmdp-modal-dialog" style="min-height:0;"></div></div>';
    ...
    UI.modal.alert = function(content, options) {
        ...
        var modal = UI.modal.dialog(([
            '<div class="vmwbmdp-margin vmwbmdp-modal-content">'+String(content)+'</div>',
            '<div class="vmwbmdp-modal-footer vmwbmdp-text-right"><button class="vmwbmdp-button vmwbmdp-button-primary vmwbmdp-modal-close">'+options.labels.Ok+'</button></div>'
        ]).join(""), options);
    ...
    UI.modal.confirm = function(content, onconfirm, oncancel) {
        ...
        var modal = UI.modal.dialog(([
            '<div class="vmwbmdp-margin vmwbmdp-modal-content">'+String(content)+'</div>',
            '<div class="vmwbmdp-modal-footer vmwbmdp-text-right"><button class="vmwbmdp-button js-modal-confirm-cancel">'+options.labels.Cancel+'</button> <button class="vmwbmdp-button vmwbmdp-button-primary js-modal-confirm">'+options.labels.Ok+'</button></div>'
        ]).join(""), options);
    ...
    UI.modal.prompt = function(text, value, onsubmit, options) {
        ...
        var modal = UI.modal.dialog(([
            text ? '<div class="vmwbmdp-modal-content vmwbmdp-form">'+String(text)+'</div>':'',
            '<div class="vmwbmdp-margin-small-top vmwbmdp-modal-content vmwbmdp-form"><p><input type="text" class="vmwbmdp-width-1-1"></p></div>',
            '<div class="vmwbmdp-modal-footer vmwbmdp-text-right"><button class="vmwbmdp-button vmwbmdp-modal-close">'+options.labels.Cancel+'</button> <button class="vmwbmdp-button vmwbmdp-button-primary js-modal-ok">'+options.labels.Ok+'</button></div>'
        ]).join(""), options),
    ...
    UI.modal.blockUI = function(content, options) {
        ...
        var modal = UI.modal.dialog(([
            '<div class="vmwbmdp-margin vmwbmdp-modal-content">'+String(content || '<div class="vmwbmdp-text-center">...</div>')+'</div>'
        ]).join(""), UI.$.extend({bgclose:false, keyboard:false, modal:false}, options));

        modal.content = modal.element.find('.vmwbmdp-modal-content:first');
    ...
    function setContent(content, modal){
        ...
        content.appendTo(modal.element.find('.vmwbmdp-modal-dialog'));
...
(function(UI) {
    ...
    UI.component('nav', {
        ...
        defaults: {
            toggle: '>li.vmwbmdp-parent > a[href="#"]',
            lists: '>li.vmwbmdp-parent > ul',
            multiple: false
        },
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-nav]', context).each(function() {
                    var nav = UI.$(this);

                    if (!nav.data('nav')) {
                        var obj = UI.nav(nav, UI.Utils.options(nav.attr('data-vmwbmdp-nav')));
                    }
                });
            });
        },
        ...
        update: function() {
            ...
            this.find(this.options.lists).each(function() {
                ...
                var $ele   = UI.$(this).attr('role', 'menu'),
                    ...
                    active = parent.hasClass("vmwbmdp-active");

                if (!parent.data('list-container')) {
                    $ele.wrap('<div style="overflow:hidden;height:0;position:relative;"></div>');
                    parent.data('list-container', $ele.parent()[active ? 'removeClass':'addClass']('vmwbmdp-hidden'));
                }

                // Init ARIA
                parent.attr('aria-expanded', parent.hasClass("vmwbmdp-open"));
        ...
        open: function(li, noanimation) {
            ...
            if (!this.options.multiple) {
                ...
                element.children('.vmwbmdp-open').not(li).each(function() {

                    var ele = UI.$(this);

                    if (ele.data('list-container')) {
                        ele.data('list-container').stop().animate({height: 0}, function() {
                            UI.$(this).parent().removeClass('vmwbmdp-open').end().addClass('vmwbmdp-hidden');
                        });
                    }
                });
            }

            $li.toggleClass('vmwbmdp-open');

            // Update ARIA
            $li.attr('aria-expanded', $li.hasClass('vmwbmdp-open'));

            if ($container) {

                if ($li.hasClass('vmwbmdp-open')) {
                    $container.removeClass('vmwbmdp-hidden');
                }

                if (noanimation) {

                    $container.stop().height($li.hasClass('vmwbmdp-open') ? 'auto' : 0);

                    if (!$li.hasClass('vmwbmdp-open')) {
                        $container.addClass('vmwbmdp-hidden');
                    }
                    ...
                    $container.stop().animate({
                        height: ($li.hasClass('vmwbmdp-open') ? getHeight($container.find('ul:first')) : 0)
                    }, function() {
...
(function(UI) {
    ...
    var scrollpos = {x: window.scrollX, y: window.scrollY},
        ...
        show: function(element, options) {
            ...
            var $body     = UI.$('body'),
                bar       = element.find('.vmwbmdp-offcanvas-bar:first'),
                rtl       = (UI.langdirection == 'right'),
                flip      = bar.hasClass('vmwbmdp-offcanvas-bar-flip') ? -1:1,
                dir       = flip * (rtl ? -1 : 1),
            ...
            element.addClass('vmwbmdp-active');

            $body.css({width: window.innerWidth - scrollbarwidth, height: window.innerHeight}).addClass('vmwbmdp-offcanvas-page');
            ...
            bar.addClass('vmwbmdp-offcanvas-bar-show');
        ...
        hide: function(force) {
            ...
            var $body = UI.$('body'),
                panel = UI.$('.vmwbmdp-offcanvas.vmwbmdp-active'),
                rtl   = (UI.langdirection == 'right'),
                bar   = panel.find('.vmwbmdp-offcanvas-bar:first'),
                finalize = function() {
                    $body.removeClass('vmwbmdp-offcanvas-page').css({width: '', height: '', marginLeft: '', marginRight: ''});
                    panel.removeClass('vmwbmdp-active');

                    bar.removeClass('vmwbmdp-offcanvas-bar-show');
                    $html.css('margin-top', '');
        ...
        _initElement: function(element) {
            ...
            element.on('click.uk.offcanvas swipeRight.uk.offcanvas swipeLeft.uk.offcanvas', function(e) {
                ...
                if (!e.type.match(/swipe/)) {
                    ...
                    if (!target.hasClass('vmwbmdp-offcanvas-close')) {
                        if (target.hasClass('vmwbmdp-offcanvas-bar')) return;
                        if (target.parents('.vmwbmdp-offcanvas-bar:first').length) return;
                    }
                }
            ...
            element.on('click', 'a[href*="#"]', function(e){
                ...
                UI.$doc.one('hide.uk.offcanvas', function() {
                    ...
                    if (target.length && UI.Utils.scrollToElement) {
                        UI.Utils.scrollToElement(target, UI.Utils.options(link.attr('data-vmwbmdp-smooth-scroll') || '{}'));
                    } else {
    ...
    UI.component('offcanvasTrigger', {
        ...
        boot: function() {
            ...
            // init code
            $html.on('click.offcanvas.uikit', '[data-vmwbmdp-offcanvas]', function(e) {
                ...
                if (!ele.data('offcanvasTrigger')) {
                    var obj = UI.offcanvasTrigger(ele, UI.Utils.options(ele.attr('data-vmwbmdp-offcanvas')));
                    ele.trigger("click");
                }
            });
...
(function(UI) {
    ...
    UI.component('switcher', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-switcher]', context).each(function() {
                    var switcher = UI.$(this);

                    if (!switcher.data('switcher')) {
                        var obj = UI.switcher(switcher, UI.Utils.options(switcher.attr('data-vmwbmdp-switcher')));
                    }
                });
            });
        },
        ...
        init: function() {
            ...
            this.connect.on('click.uk.switcher', '[data-vmwbmdp-switcher-item]', function(e) {

                e.preventDefault();

                var item = UI.$(this).attr('data-vmwbmdp-switcher-item');
        ...
        update: function() {
            ...
            this.connect.children().removeClass('vmwbmdp-active').attr('aria-hidden', 'true');

            var toggles = this.find(this.options.toggle),
                active  = toggles.filter('.vmwbmdp-active');
        ...
        show: function(tab, animate) {
            ...
            if (active.hasClass("vmwbmdp-disabled")) return;

            // Update ARIA for Toggles
            toggles.attr('aria-expanded', 'false');
            active.attr('aria-expanded', 'true');

            toggles.filter(".vmwbmdp-active").removeClass("vmwbmdp-active");
            active.addClass("vmwbmdp-active");
            ...
            if (this.options.connect && this.connect.length) {
                ...
                this.connect.each(function() {
                    ...
                    var container = UI.$(this),
                        ...
                        current   = UI.$(children.filter('.vmwbmdp-active')),
                        ...
                        animation.apply($this, [current, next]).then(function(){
                            ...
                            current.removeClass("vmwbmdp-active");
                            next.addClass("vmwbmdp-active");
    ...
    Animations = {
        ...
        'fade': function(current, next) {
            return coreAnimation.apply(this, ['vmwbmdp-animation-fade', current, next]);
        },

        'slide-bottom': function(current, next) {
            return coreAnimation.apply(this, ['vmwbmdp-animation-slide-bottom', current, next]);
        },

        'slide-top': function(current, next) {
            return coreAnimation.apply(this, ['vmwbmdp-animation-slide-top', current, next]);
        },

        'slide-vertical': function(current, next, dir) {

            var anim = ['vmwbmdp-animation-slide-top', 'vmwbmdp-animation-slide-bottom'];
        ...
        'slide-left': function(current, next) {
            return coreAnimation.apply(this, ['vmwbmdp-animation-slide-left', current, next]);
        },

        'slide-right': function(current, next) {
            return coreAnimation.apply(this, ['vmwbmdp-animation-slide-right', current, next]);
        },

        'slide-horizontal': function(current, next, dir) {

            var anim = ['vmwbmdp-animation-slide-right', 'vmwbmdp-animation-slide-left'];
        ...
        'scale': function(current, next) {
            return coreAnimation.apply(this, ['vmwbmdp-animation-scale-up', current, next]);
        }
    };
    ...
    function coreAnimation(cls, current, next) {
        ...
        release = function() {
            ...
            if (current) current.hide().removeClass('vmwbmdp-active '+clsOut+' vmwbmdp-animation-reverse');
        ...
        if (current && current.length) {
            ...
            current.css('display', 'none').addClass(clsOut+' vmwbmdp-animation-reverse').one(UI.support.animation.end, function() {
                release();
...
(function(UI) {
    ...
    UI.component('tab', {
        ...
        defaults: {
            target    : '>li:not(.vmwbmdp-tab-responsive, .vmwbmdp-disabled)',
            connect   : false,
            active    : 0,
            animation : false,
            duration  : 200,
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-tab]', context).each(function() {

                    var tab = UI.$(this);

                    if (!tab.data('tab')) {
                        var obj = UI.tab(tab, UI.Utils.options(tab.attr('data-vmwbmdp-tab')));
                    }
                });
            });
        },
        ...
        init: function() {
            ...
            this.on('click.uk.tab', this.options.target, function(e) {
                ...
                current.removeClass('vmwbmdp-active').blur();

                $this.trigger('change.uk.tab', [UI.$(this).addClass('vmwbmdp-active'), $this.current]);
            ...
            // init responsive tab
            this.responsivetab = UI.$('<li class="vmwbmdp-tab-responsive vmwbmdp-active"><a></a></li>').append('<div class="vmwbmdp-dropdown vmwbmdp-dropdown-small"><ul class="vmwbmdp-nav vmwbmdp-nav-dropdown"></ul><div>');

            this.responsivetab.dropdown = this.responsivetab.find('.vmwbmdp-dropdown');
            this.responsivetab.lst      = this.responsivetab.dropdown.find('ul');
            this.responsivetab.caption  = this.responsivetab.find('a:first');

            if (this.element.hasClass('vmwbmdp-tab-bottom')) this.responsivetab.dropdown.addClass('vmwbmdp-dropdown-up');
            ...
            this.responsivetab.lst.on('click.uk.tab', 'a', function(e) {
                ...
                $this.element.children('li:not(.vmwbmdp-tab-responsive)').eq(link.data('index')).trigger('click');
            });
            ...
            if (this.options.connect) {
                ...
                this.switcher = UI.switcher(this.element, {
                    toggle    : '>li:not(.vmwbmdp-tab-responsive)',
            ...
            // init
            $this.trigger('change.uk.tab', [this.element.find(this.options.target).not('.vmwbmdp-tab-responsive').filter('.vmwbmdp-active')]);
        ...
        check: function() {
            ...
            var children = this.element.children('li:not(.vmwbmdp-tab-responsive)').removeClass('vmwbmdp-hidden');

            if (!children.length) {
                this.responsivetab.addClass('vmwbmdp-hidden');
                return;
            }
            ...
            if (doresponsive) {
                ...
                for (var i = 0; i < children.length; i++) {
                    ...
                    if (item.css('float') != 'none' && !item.attr('vmwbmdp-dropdown')) {

                        if (!item.hasClass('vmwbmdp-disabled')) {
                        ...
                        item.addClass('vmwbmdp-hidden');
                    }
                }
            }

            this.responsivetab[this.responsivetab.lst.children('li').length ? 'removeClass':'addClass']('vmwbmdp-hidden');
        }
    });
    ...
    UI.component('cover', {
        ...
        boot: function() {
            ...
            UI.ready(function(context) {
                ...
                UI.$('[data-vmwbmdp-cover]', context).each(function(){

                    var ele = UI.$(this);

                    if(!ele.data('cover')) {
                        var plugin = UI.cover(ele, UI.Utils.options(ele.attr('data-vmwbmdp-cover')));
                    }
                });
            });
        },
...
var qcld_wpvm_vmwbmdp_contacter_unsaved = false;
jQuery(function($) {

    "use strict";

    /** INPUT which will save the settings */
    var assignInput = jQuery("#vmwbmdp-assignInput");

    /**
     * Read assignments settings.
     **/
    function vmwbmdp_readSettings () {
        ...
        try {
            ...
            jQuery("#vmwbmdp-assign-box .vmwbmdp-matching-method .vmwbmdp-button-group .vmwbmdp-button").removeClass("vmwbmdp-active");
            if(matchingMethod == 0){ jQuery("#vmwbmdp-assign-box .vmwbmdp-matching-method .vmwbmdp-button-group .vmwbmdp-all").addClass("vmwbmdp-active"); }
            if(matchingMethod == 1){ jQuery("#vmwbmdp-assign-box .vmwbmdp-matching-method .vmwbmdp-button-group .vmwbmdp-any").addClass("vmwbmdp-active"); }

            // WordPress Content
            var WPContent = aConf.WPContent;
            var WPContentVal = aConf.WPContentVal + '';
            jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-button").removeClass("vmwbmdp-active");
            if(WPContent == 0){ jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active"); }
            if(WPContent == 1){ jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-include").addClass("vmwbmdp-active"); }
            if(WPContent == 2){ jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-exclude").addClass("vmwbmdp-active"); }
            var WPContentArray = WPContentVal.split(",");
            if(WPContentVal != '') { jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content select.wp-content").val(WPContentArray).trigger("chosen:updated"); }

            // Home Page
            var homePage = aConf.homePage;
            jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-button").removeClass("vmwbmdp-active");
            if(homePage == 0){ jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active"); }
            if(homePage == 1){ jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-include").addClass("vmwbmdp-active"); }
            if(homePage == 2){ jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-exclude").addClass("vmwbmdp-active"); }

            // Menu Items
            var menuItems = aConf.menuItems;
            var menuItemsVal = aConf.menuItemsVal + '';
            jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-button").removeClass("vmwbmdp-active");
            if(menuItems == 0){ jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active"); }
            if(menuItems == 1){ jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-include").addClass("vmwbmdp-active"); }
            if(menuItems == 2){ jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-exclude").addClass("vmwbmdp-active"); }
            var menuItemsArray = menuItemsVal.split(",");
            if(menuItemsVal != '') { jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items select.menuitems").val(menuItemsArray).trigger("chosen:updated"); }

            // Date & Time
            var dateTime = aConf.dateTime;
            var dateTimeStart = aConf.dateTimeStart;
            var dateTimeEnd = aConf.dateTimeEnd;
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-button' ).removeClass( 'vmwbmdp-active' );
            if( dateTime == 0 ) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-ignore' ).addClass( 'vmwbmdp-active' ); }
            if( dateTime == 1 ) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-include' ).addClass( 'vmwbmdp-active' ); }
            if( dateTime == 2 ) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-exclude' ).addClass( 'vmwbmdp-active' ); }
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time input.vmwbmdp-period-picker-start' ).val( dateTimeStart );
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time input.vmwbmdp-period-picker-end' ).val( dateTimeEnd );
            //jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-period-picker-start' ).periodpicker( 'change' );

            // User Roles
            var userRoles = aConf.userRoles;
            var userRolesVal = aConf.userRolesVal + '';
            jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-button").removeClass("vmwbmdp-active");
            if(userRoles == 0){ jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active"); }
            if(userRoles == 1){ jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-include").addClass("vmwbmdp-active"); }
            if(userRoles == 2){ jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-exclude").addClass("vmwbmdp-active"); }
            var userRolesArray = userRolesVal.split(",");
            if(userRolesVal != '') { jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles select.user-roles").val(userRolesArray).trigger("chosen:updated"); }

            // URL
            var URL = aConf.URL;
            var URLVal = aConf.URLVal;
            jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-button").removeClass("vmwbmdp-active");
            if(URL == 0){ jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active"); }
            if(URL == 1){ jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-include").addClass("vmwbmdp-active"); }
            if(URL == 2){ jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-exclude").addClass("vmwbmdp-active"); }
            jQuery("#vmwbmdp-assign-box .vmwbmdp-url textarea.vmwbmdp-url-field").val(URLVal);

            /** Devices. */
            var devices = aConf.devices;
            var devicesVal = aConf.devicesVal + '';
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-button' ).removeClass( 'vmwbmdp-active' );
            if ( devices == 0) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-ignore' ).addClass( 'vmwbmdp-active' ); }
            if ( devices == 1) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-include' ).addClass( 'vmwbmdp-active' ); }
            if ( devices == 2) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-exclude' ).addClass( 'vmwbmdp-active' ); }
            var devicesArray = devicesVal.split( ',' );
            if ( devicesVal != '' ) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices select.devices' ).val( devicesArray ).trigger( 'chosen:updated' ); }

            // Custom PHP
            var PHP = aConf.PHP;
            var PHPVal = aConf.PHPVal;
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-button' ).removeClass( 'vmwbmdp-active' );
            if ( PHP == 0 ) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-ignore' ).addClass( 'vmwbmdp-active' ); }
            if ( PHP == 1 ) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-include' ).addClass( 'vmwbmdp-active' ); }
            if ( PHP == 2 ) { jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-exclude' ).addClass( 'vmwbmdp-active' ); }
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-php textarea.vmwbmdp-php-field' ).val( PHPVal );

        } catch (e) {

            // Reset all controls to default state
            jQuery("#vmwbmdp-assign-box .vmwbmdp-button-group .vmwbmdp-button").removeClass("vmwbmdp-active");

            // Matching Method
            jQuery("#vmwbmdp-assign-box .vmwbmdp-matching-method .vmwbmdp-button-group .vmwbmdp-all").addClass("vmwbmdp-active");

            // WordPress Content
            jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active");
            jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content select.wp-content").val("").trigger("chosen:updated");

            // Home Page
            jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active");

            // Menu Items
            jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active");
            jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items select.menuitems").val("").trigger("chosen:updated");

            /** Date & Time. */
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-ignore' ).addClass( 'vmwbmdp-active' );
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time input.vmwbmdp-period-picker-start' ).val('');
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time input.vmwbmdp-period-picker-end' ).val('');
            //jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-period-picker-start' ).periodpicker( 'change' );

            // User Roles
            jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active");
            jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles select.user-roles").val("").trigger("chosen:updated");

            // URL
            jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-ignore").addClass("vmwbmdp-active");
            jQuery("#vmwbmdp-assign-box .vmwbmdp-url textarea.vmwbmdp-url-field").val("");

            /** Devices. */
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-ignore' ).addClass( 'vmwbmdp-active' );
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices select.devices' ).val( '' ).trigger( 'chosen:updated' );

            /** Custom PHP. */
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-ignore' ).addClass( 'vmwbmdp-active' );
            jQuery( '#vmwbmdp-assign-box .vmwbmdp-php textarea.vmwbmdp-php-field' ).val('');
     ...
     * Save settings.
     **/
    function vmwbmdp_saveSettings() {

        /** Get new values */

        // Matching Method
        var matchingMethod = 0;
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-matching-method .vmwbmdp-button-group .vmwbmdp-all").hasClass("vmwbmdp-active")) { matchingMethod = 0; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-matching-method .vmwbmdp-button-group .vmwbmdp-any").hasClass("vmwbmdp-active")) { matchingMethod = 1; }

        // WordPress Content
        var WPContent = 0;
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-ignore").hasClass("vmwbmdp-active")) { WPContent = 0; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-include").hasClass("vmwbmdp-active")) { WPContent = 1; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-exclude").hasClass("vmwbmdp-active")) { WPContent = 2; }

        var WPContentVal = '';
        if(WPContent){
            WPContentVal = jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content select.wp-content").val();
        }

        // Home Page
        var homePage = 0;
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-ignore").hasClass("vmwbmdp-active")) { homePage = 0; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-include").hasClass("vmwbmdp-active")) { homePage = 1; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-exclude").hasClass("vmwbmdp-active")) { homePage = 2; }

        // Menu Items
        var menuItems = 0;
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-ignore").hasClass("vmwbmdp-active")) { menuItems = 0; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-include").hasClass("vmwbmdp-active")) { menuItems = 1; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-exclude").hasClass("vmwbmdp-active")) { menuItems = 2; }

        var menuItemsVal = '';
        if(menuItems){
            menuItemsVal = jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items select.menuitems").val();
        }

        /** Date & Time. */
        var dateTime = 0;
        if ( jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-ignore' ).hasClass( 'vmwbmdp-active' ) ) { dateTime = 0 }
        if ( jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-include' ).hasClass( 'vmwbmdp-active' ) ) { dateTime = 1 }
        if ( jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-exclude' ).hasClass( 'vmwbmdp-active' ) ) { dateTime = 2 }

        var dateTimeStart = '';
        var dateTimeEnd = '';
        if( dateTime ) {
            dateTimeStart = jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time input.vmwbmdp-period-picker-start' ).val();
            dateTimeEnd = jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time input.vmwbmdp-period-picker-end' ).val();
        }

        // User Roles
        var userRoles = 0;
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-ignore").hasClass("vmwbmdp-active")) { userRoles = 0; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-include").hasClass("vmwbmdp-active")) { userRoles = 1; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-exclude").hasClass("vmwbmdp-active")) { userRoles = 2; }

        var userRolesVal = '';
        if(userRoles){
            userRolesVal = jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles select.user-roles").val();
        }

        // URL
        var URL = 0;
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-ignore").hasClass("vmwbmdp-active")) { URL = 0; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-include").hasClass("vmwbmdp-active")) { URL = 1; }
        if(jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-exclude").hasClass("vmwbmdp-active")) { URL = 2; }

        var URLVal = '';
        if(URL){
            URLVal = jQuery("#vmwbmdp-assign-box .vmwbmdp-url textarea.vmwbmdp-url-field").val();
        }

        /** Devices. */
        var devices = 0;
        if ( jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-ignore' ).hasClass( 'vmwbmdp-active' ) ) { devices = 0; }
        if ( jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-include' ).hasClass( 'vmwbmdp-active' ) ) { devices = 1; }
        if ( jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-exclude' ).hasClass( 'vmwbmdp-active' ) ) { devices = 2; }

        var devicesVal = '';
        if( devices ){
            devicesVal = jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices select.devices' ).val();
        }

        /** Custom PHP. */
        var PHP = 0;
        if( jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-ignore' ).hasClass( 'vmwbmdp-active' ) ) { PHP = 0; }
        if( jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-include' ).hasClass( 'vmwbmdp-active' ) ) { PHP = 1; }
        if( jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-exclude' ).hasClass( 'vmwbmdp-active' ) ) { PHP = 2; }

        var PHPVal = '';
        if( PHP ) {
            PHPVal = jQuery( '#vmwbmdp-assign-box .vmwbmdp-php textarea.vmwbmdp-php-field' ).val();
        }
     ...
     * Initialization.
     **/
    function qcld_wpvm_vmwbmdp_contacter_assignment_ini() {

        /** Periodpicker. */
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-period-picker-start' ).periodpicker( {
            end: '#vmwbmdp-period-picker-end',
            todayButton: true,
        ...
        jQuery("#vmwbmdp-assign-box select.chosen-select").chosen({
            width:'100%',
        ...
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-button.vmwbmdp-active' ).click();
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-matchingMethod .vmwbmdp-button").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-matchingMethod button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        vmwbmdp_saveSettings();
    });

    /**
     * Menu Items Ignore click.
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-menuitems-selection").hide(200);
        jQuery(this).closest(".vmwbmdp-menu-items").removeClass("vmwbmdp-red vmwbmdp-green");
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-menuitems-selection").show(200);
        jQuery(this).closest(".vmwbmdp-menu-items").removeClass("vmwbmdp-red").addClass("vmwbmdp-green");
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-button-group .vmwbmdp-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-menu-items .vmwbmdp-menuitems-selection").show(200);
        jQuery(this).closest(".vmwbmdp-menu-items").removeClass("vmwbmdp-green").addClass("vmwbmdp-red");
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-ignore' ).on( 'click', function (e){
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this) .addClass( 'vmwbmdp-active' );
        jQuery( this ).closest( '.vmwbmdp-date-time' ).removeClass( 'vmwbmdp-green vmwbmdp-red' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-period-picker-box' ).hide( 200 );
        vmwbmdp_saveSettings();
    } );
     ...
     **/
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-include' ).on( 'click', function (e){
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this) .addClass( 'vmwbmdp-active' );
        jQuery( this ).closest( '.vmwbmdp-date-time' ).removeClass( 'vmwbmdp-red' ).addClass( 'vmwbmdp-green' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-period-picker-box' ).show( 200 );
        vmwbmdp_saveSettings();
    } );
     ...
     **/
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-button-group .vmwbmdp-exclude' ).on( 'click', function (e){
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this) .addClass( 'vmwbmdp-active' );
        jQuery( this ).closest( '.vmwbmdp-date-time' ).removeClass( 'vmwbmdp-green' ).addClass( 'vmwbmdp-red' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-date-time .vmwbmdp-period-picker-box' ).show( 200 );
        vmwbmdp_saveSettings();
    } );
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .user-roles-box").hide(200);
        jQuery(this).closest(".vmwbmdp-user-roles").removeClass("vmwbmdp-red vmwbmdp-green");
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .user-roles-box").show(200);
        jQuery(this).closest(".vmwbmdp-user-roles").removeClass("vmwbmdp-red").addClass("vmwbmdp-green");
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .vmwbmdp-button-group .vmwbmdp-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-user-roles .user-roles-box").show(200);
        jQuery(this).closest(".vmwbmdp-user-roles").removeClass("vmwbmdp-green").addClass("vmwbmdp-red");
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-home-page").removeClass("vmwbmdp-green vmwbmdp-red");
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-home-page").removeClass("vmwbmdp-red").addClass("vmwbmdp-green");
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group .vmwbmdp-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-home-page .vmwbmdp-button-group button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-home-page").removeClass("vmwbmdp-green").addClass("vmwbmdp-red");
        vmwbmdp_saveSettings();
    });
     ...
     * URL IGNORE click.
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-url button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-url").removeClass("vmwbmdp-green vmwbmdp-red");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-url-box").hide(200);
        vmwbmdp_saveSettings();
    });
     ...
     * URL INCLUDE click.
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-url button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-url").removeClass("vmwbmdp-red").addClass("vmwbmdp-green");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-url-box").show(200);
        vmwbmdp_saveSettings();
    });
     ...
     * URL EXCLUDE click.
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-button-group .vmwbmdp-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-url button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-url").removeClass("vmwbmdp-green").addClass("vmwbmdp-red");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-url .vmwbmdp-url-box").show(200);
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-ignore").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-wp-content").removeClass("vmwbmdp-green vmwbmdp-red");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-wp-content-box").hide(200);
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-include").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-wp-content").removeClass("vmwbmdp-red").addClass("vmwbmdp-green");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-wp-content-box").show(200);
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-button-group .vmwbmdp-exclude").on( 'click', function (e){
        e.preventDefault();
        jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content button").removeClass("vmwbmdp-active");
        jQuery(this).addClass("vmwbmdp-active");
        jQuery(this).closest(".vmwbmdp-wp-content").removeClass("vmwbmdp-green").addClass("vmwbmdp-red");
        jQuery("#vmwbmdp-assign-box .vmwbmdp-wp-content .vmwbmdp-wp-content-box").show(200);
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-ignore' ).on( 'click', function ( e ) {
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this ).addClass( 'vmwbmdp-active' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-devices-box' ).hide( 200 );
        jQuery( this ).closest( '.vmwbmdp-devices' ).removeClass( 'vmwbmdp-red vmwbmdp-green' );
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-include' ).on( 'click', function ( e ) {
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this ).addClass( 'vmwbmdp-active' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-devices-box' ).show( 200 );
        jQuery( this ).closest( '.vmwbmdp-devices' ).removeClass( 'vmwbmdp-red' ).addClass( 'vmwbmdp-green' );
        vmwbmdp_saveSettings();
    });
     ...
     **/
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-button-group .vmwbmdp-exclude' ).on( 'click', function ( e ) {
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this ).addClass( 'vmwbmdp-active' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-devices .vmwbmdp-devices-box' ).show( 200 );
        jQuery( this ).closest( '.vmwbmdp-devices' ).removeClass( 'vmwbmdp-green' ).addClass( 'vmwbmdp-red' );
        vmwbmdp_saveSettings();
    });

    /** Custom PHP IGNORE click. */
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-ignore' ).on( 'click', function ( e ){
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-php button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this ).addClass( 'vmwbmdp-active' );
        jQuery( this ).closest( '.vmwbmdp-php' ).removeClass( 'vmwbmdp-green vmwbmdp-red' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-php-box' ).hide( 200 );
        vmwbmdp_saveSettings();
    });

    /** Custom PHP INCLUDE click. */
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-include' ).on( 'click', function ( e ){
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-php button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this ).addClass( 'vmwbmdp-active' );
        jQuery( this ).closest( '.vmwbmdp-php' ).removeClass( 'vmwbmdp-red' ).addClass( 'vmwbmdp-green' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-php-box' ).show( 200 );
        vmwbmdp_saveSettings();
    });

    /** Custom PHP EXCLUDE click. */
    jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-button-group .vmwbmdp-exclude' ).on( 'click', function ( e ){
        e.preventDefault();
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-php button' ).removeClass( 'vmwbmdp-active' );
        jQuery( this ).addClass( 'vmwbmdp-active' );
        jQuery( this ).closest( '.vmwbmdp-php' ).removeClass( 'vmwbmdp-green' ).addClass( 'vmwbmdp-red' );
        jQuery( '#vmwbmdp-assign-box .vmwbmdp-php .vmwbmdp-php-box' ).show( 200 );
        vmwbmdp_saveSettings();
    });
    ...
    jQuery( 'select.wp-content, ' +
            'select.menuitems, ' +
            '.vmwbmdp-period-picker-start,  ' +
            '.vmwbmdp-period-picker-end,  ' +
            'select.user-roles,  ' +
            'textarea.vmwbmdp-url-field,  ' +
            'select.devices,  ' +
            'textarea.vmwbmdp-php-field' ).on( 'input propertychange', function () {
        vmwbmdp_saveSettings();
    } );
    ...
    jQuery( document ).ready( function () {
        ...
        jQuery( ':input' ).on( 'change', function() { qcld_wpvm_vmwbmdp_contacter_unsaved = true; } );

        /** Show warning if form not saved. */
        window.addEventListener( 'beforeunload', ( event ) => {
            if ( qcld_wpvm_vmwbmdp_contacter_unsaved ) {
        ...
        vmwbmdp_readSettings();
        qcld_wpvm_vmwbmdp_contacter_assignment_ini();

        /** Initialize Code Editor. */
        let php_editor;
        if ( jQuery( '#vmwbmdp-php-field' ).length ) {
          php_editor = wp.codeEditor.initialize( 'vmwbmdp-php-field' );
        }
