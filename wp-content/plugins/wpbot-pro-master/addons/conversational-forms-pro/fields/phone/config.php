...
<div class="qcformbuilder-config-group">
	<fieldset>
		<legend>
			<?php esc_html_e('Style', 'qcformbuilder-forms'); ?>
		</legend>
	</fieldset>

	<div class="qcformbuilder-config-field">
		<label for="{{_id}}_phone_type_local">
            <?php esc_html_e('Local', 'qcformbuilder-forms'); ?>
        </label>
	...
	<div class="qcformbuilder-config-field">
		<label for="{{_id}}_phone_type_international">
            <?php esc_html_e('International', 'qcformbuilder-forms'); ?>
        </label>
	...
	<div class="qcformbuilder-config-field">
		<label for="{{_id}}_phone_type_custom">
            ...
            <?php esc_html_e('Custom', 'qcformbuilder-forms'); ?>
        </label>
		<p class="description">
			<label for="{{_id}}_custom" class="screen-reader-text">
				<?php esc_html_e( 'Custom Phone Number Format', 'qcformbuilder-forms' ); ?>
			</label>
		...
		<p class="description" id="{{_id}}_phone_type_custom_desc">
            <?php esc_html_e('Use the digit 9 to indicate a number', 'qcformbuilder-forms'); ?>
        </p>
	</div>
</div>-->
