...
class Qcformbuilder_Forms_Render_Assets
{
	...
	public static function register()
	{
		...
		/**
		 * Filter script URLS for Chatbot Form Builder on the frontend, before they are enqueued.
		 *
		 * @since 1.3.1
		 *
		...
		/**
		 * Filter style URLS for Chatbot Form Builder on the frontend, before they are enqueued.
		 *
		 * @since 1.3.1
		 *
		 * @param array $script_urls array containing all urls to register
	...
	/**
	 * Enqueue a style for Chatbot Form Builder front-end
	 *
	 * @since 1.5.0
	 *
	...
	/**
	 * Enqueue a script for Chatbot Form Builder front-end
	 *
	 * @since 1.5.0
	 *
	...
	/**
	 * Create a URL for a script/style used by Chatbot Form Builder
	 *
	 * @since 1.5.0
	 *
