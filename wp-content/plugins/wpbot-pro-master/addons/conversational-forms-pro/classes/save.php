 ...
 * @license   GPL-2.0+
 * @link
 * @copyright 2015 QcformbuilderWP LLC
 */
class Qcformbuilder_Forms_Save_Final {
	...
	public static function do_mailer( $form, $entryid = null, $data = null, array $settings = null ) {
		...
		// do mailer!
		if ( empty( $settings ) ) {
			$sendername = __( 'Chatbot Form Builder Notification', 'qcformbuilder-forms' );
			...
			if ( ! empty( $form['mailer']['csv_data'] ) ) {
				/**
				 * Modify label or values for CSV attatched to Chatbot Form Builder email
				 *
				 * @since 1.5.3
				 *
