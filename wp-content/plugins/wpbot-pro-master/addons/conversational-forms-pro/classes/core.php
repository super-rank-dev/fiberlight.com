...
class Qcformbuilder_Forms
{
	...
	function __construct()
	{
		...
		/** Entry Viewer v1 */
		add_action('wp_ajax_qc_browse_entries', array(Qcformbuilder_Forms_Entry_UI::get_instance(), 'view_entries'));
		...
		/**
		 * Runs after Chatbot Form Builder core is initialized
		 *
		 * @since 1.3.5.3
		 */
	...
	{
		/**
		 * Use this filter to force Chatbot Form Builder styles to enqueue early -- IE force them into header
		 *
		 * @since 1.5.0
		 *
	...
	/**
	 * Makes Chatbot Form Builder load the preview
	 */
	static public function wfb_init_preview()
	{
		...
		if (!empty($preview_id)) {
			...
			if (!empty($userid)) {
				...
				if (empty($post) || $post->post_title !== 'Chatbot Form Builder Preview') {
					$temp_page = get_page_by_title('Chatbot Form Builder Preview');
					if (empty($temp_page)) {
						// create page
						$post = array(
							'post_content' => '',
							'post_name' => 'qcformbuilder_forms_preview',
							'post_title' => 'Chatbot Form Builder Preview',
							'post_status' => 'draft',
							'post_type' => 'page',
							'ping_status' => 'closed',
	...
	static function get_submit_url($form_id = '')
	{
		...
		/**
		 * Filter the Chatbot Form Builder APU url
		 *
		 * @since 1.3.2
		 *
	...
	/**
	 * Makes Chatbot Form Builder go in front-end!
	 */
	...
	/**
	 * Returns the capability to manage Chatbot Form Builder
	 *
	...
	public static function get_manage_cap($context = 'admin', $form = false)
	{
		...
		/**
		 * Change capability for managing Chatbot Form Builder
		 *
		 * @since 1.3.1
		 *
	...
	/**
	 * Load the Chatbot Form Builder REST API
	 *
	 * @since 1.4.4
	 *
	...
	public static function init_rest_api()
	{
		...
		/**
		 * Runs after Chatbot Form Builder REST API is loaded
		 *
		 * @since 1.4.4
         *
         * @param Qcformbuilder_Forms_API_Load $api_v2 Chatbot Form Builder REST API v2
         * @param \qcformbuilderwp\qcformbuilderforms\cf2\RestApi\Register $api_v3 Chatbot Form Builder REST API v2
		 */
