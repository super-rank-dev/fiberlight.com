<div class="fb_condition_item" data-itemid="placeholder">
    ...
    <div class="wpfb_private_reply_conditional_area">
        <input type="radio" name="wpfb_comment_reply_condition[placeholder]" checked="checked" value="0" />
        <i><?php echo esc_html__('Reply anytime', 'wpfb'); ?></i>
        <input type="radio" name="wpfb_comment_reply_condition[placeholder]" value="1" />
        ...
        <div class="wpfb_logical_container_comment" style="display:none">
            <div class="wpfb_logic_elem">
                <span>Comment</span><select name="wpfb_comment_condition[placeholder][]">
                ...
                </select><input type="text" name="wpfb_comment_condition_value[placeholder][]" value="" /><a class="button button-secondary wpfb_logic_remove">Remove</a><br>
    ...
    <div class="wpfb_reply_comment_area">
        <p>Reply Content:</p>
        <textarea name="wpfb_comment_reply_text[placeholder]"></textarea>
