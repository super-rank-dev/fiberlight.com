...
(function($) {
    ...
    if(flieElementOpenAi){
        ...
        $('#openaiFileList').on('click','.download_ft_file',function(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    console.log(response[0].filedata)
    ...
    if(settingsOpenAi){
        ...
        $('.qcl-openai').on('click', '#save_setting', function(){
                ...
                console.log(qcld_openai_custom_model)
                var file_id = $("input[name='file_id']" ).val();
