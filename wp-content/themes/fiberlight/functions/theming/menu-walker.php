...
class aor_menu_walker extends Walker_Nav_Menu {
...
/**
 * aor_nav_walker returns an instance of the walker_texas_ranger class with the following arguments
...
function aor_menu($location = "menu__main", $css_class_prefix = 'main-menu', $css_class_modifiers = null, $the_depth){
    ...
    $args = array(
        ...
        'walker'            => new aor_menu_walker($css_class_prefix, true),
        'depth'             => $the_depth
    );
